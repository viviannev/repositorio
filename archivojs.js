...
.then(data => { console.log(data.products)
               document.querySelector("#myData").innerHTML = "Id: " + data.products[0].id + "<br />" +
                 ...
                 "Image: " + data.products[0].image + "<br />" +
                 ...
                 "Image: " + data.products[1].image + "<br />" +
                 ...
                 "Image: " + data.products[2].image + "<br />" +
                 ...
                 "Image: " + data.products[3].image + "<br />" +
